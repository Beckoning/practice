...
//        });
        ...
        //s为map的key puts的返回值为map的value
        ConcurrentMap<String, String> testMap =  MigrateMap.makeComputingMap(s ->
            puts(s));
        ...
        for (String stringSet : testMap.keySet()){

            System.out.println(testMap.get(stringSet));
        }
        /**
         * 总结：
