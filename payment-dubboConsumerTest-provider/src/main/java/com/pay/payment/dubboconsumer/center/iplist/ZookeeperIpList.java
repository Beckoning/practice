package com.pay.payment.dubboconsumer.center.iplist;
...
public class ZookeeperIpList {
	...
	private String dataId = "/dubbo/com.pay.payment.dubboprovider.center.servcie.GreetingService/providers:1.0.0";
...
//		}
		...
		if(StringUtils.isNotEmpty(zkGroup)){
			this.dataId = "/" + zkGroup + "/" + temp[0] + "/providers";
		}else{
			this.dataId = "/" + temp[0] + "/providers";
		}
		String consumeUrl;
		if (temp.length >= 2) {
			consumeUrl = "consumer://127.0.0.1/?group=" + serviceGroup + "&interface=" + temp[0] + "&version="+ temp[1];


//			throw new RuntimeException("dataId is illegal");
		}else {
			consumeUrl = "consumer://127.0.0.1/?group=" + serviceGroup + "&interface=" + temp[0];
		}
	...
	public static void main(String[] a) throws InterruptedException {
		...
		zk.init("10.22.31.103:2181", "dubbo", "com.opay.merchant.provider.facade.MerchantFacade", "");
